...
export const getAddresses = async (_: any, __: any, context: any) => {
    try {
      ...
      const result = await context.db.query(
        'SELECT id, user_ref, postal_code, address_line_1 as add1, address_line_2 as add2, city, created_at, updated_at from address where user_ref = $1 and deleted_at IS NULL;',
        [payload.id]
      );
