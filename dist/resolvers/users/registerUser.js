...
export const registerUser = async (_, { input }, context) => {
    ...
    try {
        ...
        const result = await context.db.query('INSERT INTO users (email, password, role, onboard, created_at, updated_at, deleted_at) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id', [email, hashedPassword, role, false, execTime, execTime, null]);
