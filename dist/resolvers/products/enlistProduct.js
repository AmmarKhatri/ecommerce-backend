...
export const enlistProduct = async (_, { input }, context) => {
    ...
    try {
        ...
        const result = await context.db.query('INSERT INTO products (seller_id, image_url, name, description, price, created_at, updated_at, deleted_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id;', [payload.id, image_url, name, description, price, execTime, execTime, null]);
